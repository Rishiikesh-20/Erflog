...
export default function HackathonsPage() {
  ...
  // Filter hackathons based on search only
              ...
              return (
                <motion.div
                  ...
                  style={{
                    borderColor: "#E5E0D8",
                    background:
                      "linear-gradient(135deg, rgba(255,255,255,0.95) 0%, rgba(249,247,243,0.95) 100%)",
                  }}
                >
                  {/* Card Header */}
                  <div
                  ...
                  {/* Dates & Location Row */}
                  {(hackathon.posted_at ||
                    hackathon.expiration_date ||
                    hackathon.location ||
                    hackathon.bounty_amount) && (
                    <div
                      className="px-6 py-4 bg-gradient-to-r from-gray-50 to-slate-50 border-b grid grid-cols-2 gap-3"
                      style={{ borderColor: "#E5E0D8" }}
                    >
                      {/* Start Date */}
                      {hackathon.posted_at && (
                        <div className="flex items-center gap-2 text-sm">
                          ...
                          <div>
                            ...
                            <p className="font-medium text-gray-900 text-xs">
                              {new Date(hackathon.posted_at).toLocaleDateString(
                                "en-IN",
                                {
                                  month: "short",
                                  day: "numeric",
                      ...
                      {hackathon.expiration_date && (
                        <div className="flex items-center gap-2 text-sm">
                          <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-red-400 to-red-600 flex items-center justify-center flex-shrink-0">
                      ...
                      {hackathon.location && (
                        <div className="flex items-center gap-2 text-sm">
                          <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-gray-400 to-slate-500 flex items-center justify-center flex-shrink-0">
                      ...
                      {hackathon.bounty_amount && (
                        <div className="flex items-center gap-2 text-sm">
                          <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-yellow-400 to-amber-500 flex items-center justify-center flex-shrink-0">
